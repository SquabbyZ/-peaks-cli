...
# These should fail
run_test "sc impact reject missing change-id (should fail)" "! $PEAKS sc impact --json"
run_test "sc retention reject missing slice-id (should fail)" "! $PEAKS sc retention --json"
